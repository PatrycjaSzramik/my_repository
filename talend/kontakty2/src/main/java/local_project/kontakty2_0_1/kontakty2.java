...
package local_project.kontakty2_0_1;
...
/**
 * Job: kontakty2 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class kontakty2 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "kontakty2";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(kontakty2.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_LOCAL_PROJECT_kontakty2 = new byte[0];
    static byte[] commonByteArray_LOCAL_PROJECT_kontakty2 = new byte[0];
			    ...
			    public Integer klientId;

				public Integer getKlientId () {
					return this.klientId;
				}
				
			    public Integer pracownikId;
			    ...
			    public java.util.Date kontaktTs;

				public java.util.Date getKontaktTs () {
					return this.kontaktTs;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LOCAL_PROJECT_kontakty2.length) {
				if(length < 1024 && commonByteArray_LOCAL_PROJECT_kontakty2.length == 0) {
   					commonByteArray_LOCAL_PROJECT_kontakty2 = new byte[1024];
				} else {
   					commonByteArray_LOCAL_PROJECT_kontakty2 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LOCAL_PROJECT_kontakty2, 0, length);
			strReturn = new String(commonByteArray_LOCAL_PROJECT_kontakty2, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LOCAL_PROJECT_kontakty2) {

        	try {

        		int length = 0;
		
						this.kontaktId = readInteger(dis);
					
						this.klientId = readInteger(dis);
					
						this.pracownikId = readInteger(dis);
					
					this.status = readString(dis);
					
					this.kontaktTs = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.kontaktId,dos);
					
					// Integer
				
						writeInteger(this.klientId,dos);
					
					// Integer
				
						writeInteger(this.pracownikId,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("kontaktId="+String.valueOf(kontaktId));
		sb.append(",klientId="+String.valueOf(klientId));
		sb.append(",pracownikId="+String.valueOf(pracownikId));
		sb.append(",status="+status);
		sb.append(",kontaktTs="+String.valueOf(kontaktTs));
	    sb.append("]");
...
class Comparablerow2Struct extends row2Struct implements Comparable<Comparablerow2Struct> {
	...
	public int compareTo(Comparablerow2Struct other) {
		...
		if(this.klientId == null && other.klientId != null){
			return -1;
						
		}else if(this.klientId != null && other.klientId == null){
			return 1;
						
		}else if(this.klientId != null && other.klientId != null){
			if(!this.klientId.equals(other.klientId)){
				return this.klientId.compareTo(other.klientId);
			}
		}
		if(this.kontaktTs == null && other.kontaktTs != null){
			return -1;
						
		}else if(this.kontaktTs != null && other.kontaktTs == null){
			return 1;
						
		}else if(this.kontaktTs != null && other.kontaktTs != null){
			if(!this.kontaktTs.equals(other.kontaktTs)){
				return this.kontaktTs.compareTo(other.kontaktTs);
			}
		}
		return 0;
	}
 ...
 */
    ...
    class ConvertJSONString_tFileInputJSON_1{
        ...
        de.odysseus.staxon.json.JsonXMLConfig config_tFileInputJSON_1 = new de.odysseus.staxon.json.JsonXMLConfigBuilder().multiplePI(false).build();
        de.odysseus.staxon.json.JsonXMLInputFactory jsonXMLInputFactory_tFileInputJSON_1 = new de.odysseus.staxon.json.JsonXMLInputFactory(config_tFileInputJSON_1);
        javax.xml.stream.XMLOutputFactory xmlOutputFactory_tFileInputJSON_1 = javax.xml.stream.XMLOutputFactory.newInstance();
        ...
        try {
            filenameOrStream_tFileInputJSON_1 = "D:/statuses.json";
        ...
        String loopQuery_tFileInputJSON_1 =  "/records" ;
        ...
        try{
            if(filenameOrStream_tFileInputJSON_1 instanceof java.io.InputStream){
                br_tFileInputJSON_1 = new java.io.BufferedReader(new java.io.InputStreamReader((java.io.InputStream)filenameOrStream_tFileInputJSON_1,"UTF-8"));
            }else{
            	    br_tFileInputJSON_1 = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(String.valueOf(filenameOrStream_tFileInputJSON_1)), "UTF-8"));
            }
            ...
            javax.xml.stream.XMLEventReader xmlEventReader_tFileInputJSON_1 = jsonXMLInputFactory_tFileInputJSON_1.createXMLEventReader(bais_tFileInputJSON_1);
            javax.xml.stream.XMLEventWriter xmLEventWriter_tFileInputJSON_1 = xmlOutputFactory_tFileInputJSON_1.createXMLEventWriter(baos_tFileInputJSON_1,"UTF-8");
            ...
            doc_tFileInputJSON_1= reader_tFileInputJSON_1.read(new java.io.StringReader(xmlStr_tFileInputJSON_1));
        }catch(java.lang.Exception e_tFileInputJSON_1){
        ...
        if(isValidFile_tFileInputJSON_1){
            ...
            java.util.List<org.dom4j.Node> nodeList_tFileInputJSON_1 = (java.util.List<org.dom4j.Node>)x_tFileInputJSON_1.selectNodes(doc_tFileInputJSON_1);  
            ...
            //init all mapping xpaths
                org.dom4j.XPath xTmp0_tFileInputJSON_1 = org.dom4j.DocumentHelper.createXPath("kontakt_id");
                xTmp0_tFileInputJSON_1.setNamespaceURIs(xmlNameSpaceMap_tFileInputJSON_1);
                org.dom4j.XPath xTmp1_tFileInputJSON_1 = org.dom4j.DocumentHelper.createXPath("klient_id");
                xTmp1_tFileInputJSON_1.setNamespaceURIs(xmlNameSpaceMap_tFileInputJSON_1);
                org.dom4j.XPath xTmp2_tFileInputJSON_1 = org.dom4j.DocumentHelper.createXPath("pracownik_id");
                xTmp2_tFileInputJSON_1.setNamespaceURIs(xmlNameSpaceMap_tFileInputJSON_1);
                org.dom4j.XPath xTmp3_tFileInputJSON_1 = org.dom4j.DocumentHelper.createXPath("status");
                xTmp3_tFileInputJSON_1.setNamespaceURIs(xmlNameSpaceMap_tFileInputJSON_1);
                org.dom4j.XPath xTmp4_tFileInputJSON_1 = org.dom4j.DocumentHelper.createXPath("kontakt_ts");
                    ...
                    try{
                        ...
                        if(obj0_tFileInputJSON_1 == null) {
                            ...
                            node_tFileInputJSON_1 = (org.dom4j.Node)obj0_tFileInputJSON_1;
                                str_tFileInputJSON_1 = org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                        } else if(obj0_tFileInputJSON_1 instanceof String || obj0_tFileInputJSON_1 instanceof Number){
                            ...
                            node_tFileInputJSON_1 = nodes_tFileInputJSON_1.size()>0 ? nodes_tFileInputJSON_1.get(0) : null;
                                str_tFileInputJSON_1 = node_tFileInputJSON_1==null?"":org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                        }  
                                            if(xml_api_tFileInputJSON_1.isDefNull(node_tFileInputJSON_1)){
                                                row1.kontaktId =null;
                                            }else if(xml_api_tFileInputJSON_1.isEmpty(node_tFileInputJSON_1) || xml_api_tFileInputJSON_1.isMissing(node_tFileInputJSON_1)){
                                                row1.kontaktId=null;
                                            }else{
                                        row1.kontaktId = ParserUtils.parseTo_Integer(str_tFileInputJSON_1);
                                            }
                        ...
                        if(obj1_tFileInputJSON_1 == null) {
                            ...
                            node_tFileInputJSON_1 = (org.dom4j.Node)obj1_tFileInputJSON_1;
                                str_tFileInputJSON_1 = org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                        } else if(obj1_tFileInputJSON_1 instanceof String || obj1_tFileInputJSON_1 instanceof Number){
                            node_tFileInputJSON_1 = temp_tFileInputJSON_1;
                            ...
                            node_tFileInputJSON_1 = nodes_tFileInputJSON_1.size()>0 ? nodes_tFileInputJSON_1.get(0) : null;
                                str_tFileInputJSON_1 = node_tFileInputJSON_1==null?"":org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                                        ...
                                        row1.klientId = ParserUtils.parseTo_Integer(str_tFileInputJSON_1);
                                            }
                        ...
                        if(obj2_tFileInputJSON_1 == null) {
                            ...
                            node_tFileInputJSON_1 = (org.dom4j.Node)obj2_tFileInputJSON_1;
                                str_tFileInputJSON_1 = org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                        } else if(obj2_tFileInputJSON_1 instanceof String || obj2_tFileInputJSON_1 instanceof Number){
                            node_tFileInputJSON_1 = temp_tFileInputJSON_1;
                            ...
                            node_tFileInputJSON_1 = nodes_tFileInputJSON_1.size()>0 ? nodes_tFileInputJSON_1.get(0) : null;
                                str_tFileInputJSON_1 = node_tFileInputJSON_1==null?"":org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                                            ...
                                            if(xml_api_tFileInputJSON_1.isDefNull(node_tFileInputJSON_1)){
                                                row1.pracownikId =null;
                                            }else if(xml_api_tFileInputJSON_1.isEmpty(node_tFileInputJSON_1) || xml_api_tFileInputJSON_1.isMissing(node_tFileInputJSON_1)){
                                                row1.pracownikId=null;
                                            }else{
                                        row1.pracownikId = ParserUtils.parseTo_Integer(str_tFileInputJSON_1);
                                            }
                        ...
                        if(obj3_tFileInputJSON_1 == null) {
                            ...
                            node_tFileInputJSON_1 = (org.dom4j.Node)obj3_tFileInputJSON_1;
                                str_tFileInputJSON_1 = org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                        } else if(obj3_tFileInputJSON_1 instanceof String || obj3_tFileInputJSON_1 instanceof Number){
                            node_tFileInputJSON_1 = temp_tFileInputJSON_1;
                            ...
                            node_tFileInputJSON_1 = nodes_tFileInputJSON_1.size()>0 ? nodes_tFileInputJSON_1.get(0) : null;
                                str_tFileInputJSON_1 = node_tFileInputJSON_1==null?"":org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                                        ...
                                        row1.status = str_tFileInputJSON_1;
                                            }
                        ...
                        if(obj4_tFileInputJSON_1 == null) {
                            ...
                            node_tFileInputJSON_1 = (org.dom4j.Node)obj4_tFileInputJSON_1;
                                str_tFileInputJSON_1 = org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                        } else if(obj4_tFileInputJSON_1 instanceof String || obj4_tFileInputJSON_1 instanceof Number){
                            node_tFileInputJSON_1 = temp_tFileInputJSON_1;
                            ...
                            node_tFileInputJSON_1 = nodes_tFileInputJSON_1.size()>0 ? nodes_tFileInputJSON_1.get(0) : null;
                                str_tFileInputJSON_1 = node_tFileInputJSON_1==null?"":org.jaxen.function.StringFunction.evaluate(node_tFileInputJSON_1,org.jaxen.dom4j.DocumentNavigator.getInstance());
                                            ...
                                            row1.kontaktTs = ParserUtils.parseTo_Date(str_tFileInputJSON_1, "yyyy-MM-dd HH:mm:ss");
                                            }
...
row1.kontaktTs.after( TalendDate.parseDate("yyyy-MM-dd","2017-07-01" ))
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.kontaktId = row1.kontaktId;
               row2.klientId = row1.klientId;
               row2.pracownikId = row1.pracownikId;
               row2.status = row1.status;
               row2.kontaktTs = row1.kontaktTs;    
...
if(row2 != null) { 
	...
	arrayRowtSortRow_1_SortOut.kontaktId = row2.kontaktId;
	arrayRowtSortRow_1_SortOut.klientId = row2.klientId;
	arrayRowtSortRow_1_SortOut.pracownikId = row2.pracownikId;
	arrayRowtSortRow_1_SortOut.status = row2.status;
	arrayRowtSortRow_1_SortOut.kontaktTs = row2.kontaktTs;	
...
for(int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++){
	...
	row3.kontaktId = current_tSortRow_1_SortIn.kontaktId;
	row3.klientId = current_tSortRow_1_SortIn.klientId;
	row3.pracownikId = current_tSortRow_1_SortIn.pracownikId;
	row3.status = current_tSortRow_1_SortIn.status;
	row3.kontaktTs = current_tSortRow_1_SortIn.kontaktTs;
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(row3.kontaktId != null) {
                        sb_tFileOutputDelimited_1.append(
                            row3.kontaktId
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row3.klientId != null) {
                        sb_tFileOutputDelimited_1.append(
                            row3.klientId
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row3.pracownikId != null) {
                        sb_tFileOutputDelimited_1.append(
                            row3.pracownikId
                        );
                            }
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row3.kontaktTs != null) {
                        sb_tFileOutputDelimited_1.append(
                            FormatterUtils.format_Date(row3.kontaktTs, "yyyy-MM-dd HH:mm:ss")
                        );
                            }
 ...
 */
    ...
    public static void main(String[] args){
        final kontakty2 kontakty2Class = new kontakty2();

        int exitCode = kontakty2Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = kontakty2.class.getClassLoader().getResourceAsStream("local_project/kontakty2_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = kontakty2.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : kontakty2");
        }
...
/************************************************************************************************
 *     88474 characters generated by Talend Open Studio for Data Integration 
 *     on the 22 stycznia 2021 11:35:59 CET
 ************************************************************************************************/